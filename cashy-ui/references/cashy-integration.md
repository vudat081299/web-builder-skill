...
| `cash-navbar` / `cash-nav` / `cash-sidenav` (app-shell navigation) | plain markup + classes; drive `.is-active` from your **router** (React Router `NavLink`), and wire the mobile menu/collapse toggle in app JS |
